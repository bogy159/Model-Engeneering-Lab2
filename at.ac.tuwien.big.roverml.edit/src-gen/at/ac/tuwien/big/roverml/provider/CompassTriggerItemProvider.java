...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.roverml.CompassTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompassTriggerItemProvider extends TriggeredTransitionItemProvider {
	...
	public String getText(Object object) {
		String label = ((CompassTrigger)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CompassTrigger_type") :
