...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.roverml.Move} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveItemProvider extends CommandItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RoverMLPackage.Literals.MOVE__SPEED,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RoverMLPackage.Literals.MOVE__SPEED);
			childrenFeatures.add(RoverMLPackage.Literals.MOVE__DISTANCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RoverMLPackage.Literals.MOVE__DISTANCE,
