...
public class RovermlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RovermlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTriggeredTransitionAccess().getGroup_2_2(), "rule__TriggeredTransition__Group_2_2__0");
			builder.put(grammarAccess.getTriggeredTransitionAccess().getGroup_2_5(), "rule__TriggeredTransition__Group_2_5__0");
			...
			builder.put(grammarAccess.getActuatorAccess().getGroup_1(), "rule__Actuator__Group_1__0");
			...
			builder.put(grammarAccess.getRoverProgramAccess().getBlockAssignment_2(), "rule__RoverProgram__BlockAssignment_2");
			...
			builder.put(grammarAccess.getRoverAccess().getComponentsAssignment_2(), "rule__Rover__ComponentsAssignment_2");
			...
			builder.put(grammarAccess.getTriggeredTransitionAccess().getSensorAssignment_2_2_1(), "rule__TriggeredTransition__SensorAssignment_2_2_1");
			builder.put(grammarAccess.getTriggeredTransitionAccess().getOperatorAssignment_2_4(), "rule__TriggeredTransition__OperatorAssignment_2_4");
			builder.put(grammarAccess.getTriggeredTransitionAccess().getComparisonValueAssignment_2_5_1(), "rule__TriggeredTransition__ComparisonValueAssignment_2_5_1");
			builder.put(grammarAccess.getSingleQuantityAccess().getValueAssignment_3_4(), "rule__SingleQuantity__ValueAssignment_3_4");
			...
			builder.put(grammarAccess.getSensorAccess().getLastSensedValueAssignment_2_3(), "rule__Sensor__LastSensedValueAssignment_2_3");
			builder.put(grammarAccess.getComponentAccess().getKindAssignment_1_4(), "rule__Component__KindAssignment_1_4");
			builder.put(grammarAccess.getRoverSystemAccess().getRoversAssignment_3(), "rule__RoverSystem__RoversAssignment_3");
			builder.put(grammarAccess.getRoverSystemAccess().getRoverProgramsAssignment_4(), "rule__RoverSystem__RoverProgramsAssignment_4");
