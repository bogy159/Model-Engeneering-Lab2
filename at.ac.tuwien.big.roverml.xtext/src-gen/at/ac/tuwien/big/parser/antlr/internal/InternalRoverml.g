...
@after {
	...
	(
		...
		{
			$current = $this_RoverProgram_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Command_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
